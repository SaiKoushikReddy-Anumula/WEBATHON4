      ...
      <div className="container mx-auto p-6">
        <form onSubmit={handleSearch} className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-gray-700 mb-2">Min Contribution Score</label>
              <input
                type="number"
                step="0.1"
                min="1"
            ...
            <div>
              <label className="block text-gray-700 mb-2">Max Contribution Score</label>
              <input
                type="number"
                step="0.1"
                min="1"
              ...
              <div className="mb-3">
                ...
                {user.contributionScore && (
                  <span className="ml-2 text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded">
                    ⭐ {user.contributionScore.toFixed(1)}/5.0
                  </span>
                )}
              </div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {selectedUser.contributionScore && (
                  <p className="text-sm text-yellow-600 font-semibold">⭐ Contribution Score: {selectedUser.contributionScore.toFixed(1)}/5.0 ({selectedUser.totalRatings || 0} ratings)</p>
                )}
              </div>
